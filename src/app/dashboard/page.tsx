...
export default function DashboardPage() {
  ...
  const [weeks, setWeeks] = useState<WeekData[]>([
    {
      ...
      workouts: [
        ...
        { id: "w1-thu", day: "Thursday", date: "Jun 12", type: "run", trainingType: "ClosePace", title: "Race Pace", miles: 10, description: "2 mi WU | 2@8:40 | 2@8:20 | 2@8:40 | 1 CD", paceTarget: "8:20-8:40/mi", coachNotes: "Pretty cut and dry — 2mi warm up, 7mi at close to race pace at 8:50, 1mi cool down.", completed: false },
        { id: "w1-fri", day: "Friday", date: "Jun 13", type: "cross", trainingType: "OrangeTheory", title: "Orange Theory", miles: null, description: "OT class", completed: false },
    ...
    },
    {
      ...
      workouts: [
        { id: "w2-mon", day: "Monday", date: "Jun 2", type: "cross", trainingType: "CrossTraining", title: "Bike / Strength", miles: null, description: "Cross training day. Bike and strength work.", completed: true, log: { rpe: "6", stress: "", notes: "Felt good", energy: "7", motivation: "8", sleep: "7", strength: "7", recovery: "6", mood: "8", hunger: "7" } },
        { id: "w2-tue", day: "Tuesday", date: "Jun 3", type: "run", trainingType: "Hills", title: "HILLS - Technique Day", miles: 7, description: "2 WU | 1 down | 1 up | 1 down | 1 up | 1 CD", paceTarget: "Downhill close to race pace", location: "Location specific hills", coachNotes: "This first training day is for technique. Jeff will run the downs with you to help coach you on keeping head up, not leaning too far forward, but yet allowing gravity to help you down, without falling.", completed: true, log: { rpe: "8", stress: "", notes: "Jeff was great help", energy: "8", motivation: "9", sleep: "7", strength: "7", recovery: "7", mood: "9", hunger: "6", actualMiles: "7.2", actualPace: "8:45", onPeriod: "yes" } },
        ...
        { id: "w2-thu", day: "Thursday", date: "Jun 5", type: "run", trainingType: "SpeedRoad", title: "Strides", miles: 7, description: "7 mi w/strides", completed: true, log: { rpe: "7", stress: "", notes: "Legs felt heavy from hills", energy: "6", motivation: "7", sleep: "6", strength: "6", recovery: "5", mood: "7", hunger: "7" } },
        { id: "w2-fri", day: "Friday", date: "Jun 6", type: "cross", trainingType: "CrossTraining", title: "Bike / Strength", miles: null, description: "Cross training day. Bike and strength work.", completed: true, log: { rpe: "5", stress: "", notes: "", energy: "7", motivation: "7", sleep: "8", strength: "7", recovery: "7", mood: "8", hunger: "7" } },
        { id: "w2-sat", day: "Saturday", date: "Jun 7", type: "run", trainingType: "RacePace", title: "Race Pace Workout", miles: 12, description: "5 WU | 5 mi @ 9:15 (2 min rest between miles) | 2 CD", paceTarget: "9:15/mi race pace", coachNotes: "12 mi total workout at race pace.", completed: true, log: { rpe: "9", stress: "Travel Day", notes: "War Eagle! Fun easy run.", energy: "8", motivation: "9", sleep: "7", strength: "8", recovery: "6", mood: "9", hunger: "8", actualMiles: "12.1", actualPace: "9:12" } },
  ...
  const getTrainingTypeLabel = (tt: string) => {
    switch (tt) { case "SpeedRoad": return "Speed Workout - Road"; case "SpeedTrack": return "Speed Workout - Track"; case "Tempo": return "Tempo Runs"; case "Threshold": return "Threshold Runs"; case "LongRun": return "Long Run"; case "Easy": return "Easy Run"; case "Recovery": return "Recovery Run"; case "Hills": return "Hill Repeats"; case "Intervals": return "Intervals (Run/Walk)"; case "RacePace": return "Race Pace"; case "ClosePace": return "Close to Race Pace"; case "TimeTrial": return "Time Trial"; case "CrossTraining": return "Cross Training"; case "OrangeTheory": return "Orange Theory"; case "Rest": return "Rest"; case "Speed": return "Speed Workout"; case "HR": return "Heart Rate"; case "LR": return "Long Run"; case "CT": return "Cross Training"; case "OT": return "Orange Theory"; default: return tt; }
  };
  const getTrainingTypeBadge = (tt: string) => {
    switch (tt) { case "SpeedRoad": case "SpeedTrack": return "bg-red-500/20 text-red-400 border-red-500/30"; case "Tempo": case "Threshold": return "bg-orange-500/20 text-orange-400 border-orange-500/30"; case "LongRun": case "Easy": case "Recovery": return "bg-blue-500/20 text-blue-400 border-blue-500/30"; case "Hills": return "bg-yellow-500/20 text-yellow-400 border-yellow-500/30"; case "RacePace": case "ClosePace": return "bg-green-500/20 text-green-300 border-green-500/30"; case "Intervals": return "bg-cyan-500/20 text-cyan-400 border-cyan-500/30"; case "TimeTrial": return "bg-red-500/20 text-red-300 border-red-500/30"; case "CrossTraining": case "OrangeTheory": return "bg-purple-500/20 text-purple-400 border-purple-500/30"; case "Rest": return "bg-green-500/20 text-green-400 border-green-500/30"; case "HR": return "bg-pink-500/20 text-pink-400 border-pink-500/30"; case "LR": return "bg-blue-500/20 text-blue-400 border-blue-500/30"; case "CT": case "OT": return "bg-purple-500/20 text-purple-400 border-purple-500/30"; case "Speed": return "bg-red-500/20 text-red-400 border-red-500/30"; default: return "bg-gray-500/20 text-gray-400 border-gray-500/30"; }
  };
          ...
          <>
            ...
            <div className="bg-secondary/50 border border-white/10 rounded-2xl p-6">
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                <select value={filters.type} onChange={(e) => setFilters({ ...filters, type: e.target.value as FilterOptions["type"] })} className="bg-primary/50 border border-white/10 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-accent"><option value="all">All Types</option><option value="run">Running</option><option value="cross">Cross Training</option><option value="rest">Rest</option></select>
