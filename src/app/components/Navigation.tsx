    ...
    <nav className="fixed top-0 w-full bg-primary/95 backdrop-blur-sm z-50 border-b border-white/10">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="/login?role=client" className="hover:text-accent transition-colors">
            Client Login
          </a>
      ...
      {isOpen && (
        <div className="md:hidden bg-secondary border-t border-white/10 px-6 py-4 space-y-4">
          ...
          <a href="/login?role=client" className="block hover:text-accent transition-colors" onClick={() => setIsOpen(false)}>
            Client Login
          </a>
