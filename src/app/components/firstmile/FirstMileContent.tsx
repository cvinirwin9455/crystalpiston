...
export default function FirstMileContent() {
  return (
    <div className="fmc">
      ...
      {/* Mobile Login Bar (visible only on mobile) */}
      <div className="fmc-mobile-login-bar">
        <a href="/login?role=coach" className="fmc-mobile-login-btn fmc-mobile-login-btn-coach">
        ...
        <a href="/login?role=client" className="fmc-mobile-login-btn fmc-mobile-login-btn-client">
