    ...
    <div className="fmc">
      ...
      <section className="fmc-hero">
        ...
        <div className="fmc-hero-content">
          ...
          <p className="fmc-hero-subhead">
            The simplest platform for new running coaches and personal trainers to manage clients — for just <strong>$1/month per 10 active clients</strong>. No complex features you don&apos;t need. No lock-in. Just the tools to get you started.
          </p>
        </div>
      ...
      <section className="fmc-the-fork">
        <div className="fmc-container">
          ...
          <p className="fmc-fork-sub fmc-fade-in">
            Other platforms charge $50–$200/month before you&apos;ve even landed your first client. You shouldn&apos;t have to choose between professional tools and paying your bills. We built First Mile Coach so you can have both from day one.
          </p>
        ...
        <div className="fmc-container">
          <div className="fmc-reality-content fmc-fade-in">
            ...
            <p className="fmc-reality-pitch">
              It doesn&apos;t have to be like this. For $1/month you can look professional from day one — with digital plans, client dashboards, and everything in one place. No more flipping through notebooks to remember what you assigned last week.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="fmc-pricing-content fmc-fade-in">
            ...
            <div className="fmc-price-card">
              <div className="fmc-price-amount">
                <span className="fmc-price-currency">$1</span>
            ...
            <div className="fmc-pricing-mau fmc-fade-in">
              ...
              <p>
                You only pay for clients who are <strong>active that month</strong>. Had 15 clients last month but only 8 this month? Your bill drops from $2 to $1. Just archive clients who aren&apos;t currently training with you — they won&apos;t count towards your active total. Unarchive them anytime they come back.
              </p>
            </div>

            <p className="fmc-pricing-note">
              That&apos;s not a typo. We&apos;re not trying to make money off coaches who are just starting out. We charge $1 per 10 clients to keep the lights on and the spammers out.
            </p>
            <p className="fmc-pricing-note">
      ...
      <section className="fmc-path-section fmc-runner-path" id="philosophy">
        <div className="fmc-container">
          <div className="fmc-path-header fmc-fade-in">
            ...
            <p>Here&apos;s the honest truth: other platforms might have more features for bigger operations. But if you want to stay with us as you grow, you can — and it&apos;ll only ever cost $1 per 10 active clients. We&apos;re your first mile, but we&apos;re happy to be your hundredth too.</p>
          </div>
            ...
            <div className="fmc-path-steps">
              ...
              <div className="fmc-path-step">
                ...
                <div>
                  ...
                  <p>Stay with us as long as you want. It&apos;s just $1 per 10 active clients per month — so even at 100 clients you&apos;re paying $10/month. No obligation to leave, ever. And if you have a quiet month, your bill goes down automatically.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="fmc-container">
          <div className="fmc-stats-grid fmc-fade-in">
            <div className="fmc-stat">
              <div className="fmc-stat-number">$1</div>
              <div className="fmc-stat-label">Per 10 active clients/month</div>
            </div>
            <div className="fmc-stat">
              <div className="fmc-stat-number">$10</div>
      ...
      <footer className="fmc-footer">
        <div className="fmc-container">
          ...
          <p className="fmc-footer-tagline">The cheapest, simplest way to start coaching. $1/month per 10 active clients.</p>
