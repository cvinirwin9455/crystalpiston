...
// This allows different wording for coaches vs clients
...
/**
 * Send invite email to a new COACH (used by super-admin activate and coach invite)
 */
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 520px; background-color: #ffffff; border-radius: 16px; border: 1px solid rgba(0,0,0,0.08); overflow: hidden; box-shadow: 0 4px 30px rgba(0,0,0,0.06);">
          ...
          <tr>
            <td style="padding: 40px 32px;">
              ...
              <p style="margin: 0 0 20px; font-size: 16px; color: #555b5e; line-height: 1.7;">
                Your coach account on <strong style="color: #f26522;">First Mile Coach</strong> is ready. Click the button below to set your password and start managing your clients.
              </p>
          ...
          <tr>
            <td style="padding: 20px 32px; border-top: 1px solid rgba(0,0,0,0.06); text-align: center; background: #fafbfc;">
              <p style="margin: 0; font-size: 12px; color: #9e9e9e;">First Mile Coach &mdash; The simplest way to manage your coaching clients</p>
            </td>
          </tr>
        </table>
      </td>
...
/**
 * Send invite email to a new CLIENT (used when a coach creates a client)
 */
export async function sendClientInviteEmail(params: {
  ...
  const { to, clientName, coachName, confirmationUrl } = params
  const firstName = clientName.split(' ')[0]
  const senderEmail = process.env.SENDER_EMAIL || process.env.FIRSTMILE_SENDER_EMAIL || 'noreply@firstmilecoach.com'
    ...
    <tr>
      <td align="center">
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 520px; background-color: #ffffff; border-radius: 16px; border: 1px solid rgba(0,0,0,0.08); overflow: hidden; box-shadow: 0 4px 30px rgba(0,0,0,0.06);">
              ...
              <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto;">
                <tr>
                  <td align="center" style="padding-right: 16px;">
                    <img src="https://www.firstmilecoach.com/firstmile/logo.png" alt="First Mile Coach" width="100" style="display: block; border-radius: 8px;" />
                  </td>
                  <td align="center" style="padding-left: 16px;">
                    <img src="https://www.crystalpistolperformance.com/IMG_5861.PNG" alt="Pistol Performance Coaching" width="80" style="display: block;" />
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding: 20px 32px; border-top: 1px solid rgba(0,0,0,0.06); text-align: center; background: #fafbfc;">
              <p style="margin: 0; font-size: 12px; color: #9e9e9e;">Powered by First Mile Coach</p>
            </td>
          </tr>
        </table>
      </td>
