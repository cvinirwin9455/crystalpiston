  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-16 right-4 z-40 flex items-center gap-2 px-3 py-2 rounded-full shadow-lg bg-[#1a1a2e] border border-[#2a2a4e] hover:bg-[#2a2a4e] transition-all hover:scale-105 text-white text-sm font-medium always-dark"
