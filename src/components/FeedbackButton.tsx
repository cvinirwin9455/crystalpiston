  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-40 flex items-center gap-2 px-3 py-2 rounded-full shadow-lg bg-secondary border border-white/10 hover:bg-primary transition-all hover:scale-105 text-white text-sm font-medium"
      ...
      {showModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
          ...
          {/* Modal */}
          <div className="relative w-full max-w-md bg-secondary border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
            {/* Header */}
              ...
              <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4 max-h-[65vh] overflow-y-auto">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 bg-primary/50 border border-white/10 rounded-lg text-white text-sm placeholder-gray-500 focus:outline-none focus:border-accent/50 focus:ring-1 focus:ring-accent/30 resize-none"
                  />
                </div>
                ...
                <div>
                  ...
                  {screenshotPreview ? (
                    ...
                    <button
                      ...
                      className="w-full py-3 px-4 border border-dashed border-white/20 rounded-lg text-gray-400 text-sm hover:border-accent/40 hover:text-gray-300 transition-all flex items-center justify-center gap-2"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
